...
import { ChevronLeft, CircleCut } from '@untitledui/icons'
...
function ChangeProfileMobile({ isOpen = false, user, onClose, onUpdated }) {
  ...
  return (
    <div
      className="change-profile-mobile"
      role="dialog"
      aria-modal="true"
      aria-labelledby="change-profile-mobile-title"
      aria-describedby="change-profile-mobile-description"
    >
      <BackgroundMain />

      <form className="change-profile-mobile__shell" onSubmit={handleSubmit}>
        <div className="change-profile-mobile__card">
          <div className="change-profile-mobile__header">
            <button
              type="button"
              className="change-profile-mobile__back"
              aria-label="Kembali dari halaman change profile"
              onClick={handleClose}
            ...
            <div className="change-profile-mobile__heading">
              <h2 className="change-profile-mobile__title" id="change-profile-mobile-title">
                Change Profile
              </h2>
              <p className="change-profile-mobile__text" id="change-profile-mobile-description">
          ...
          <div className="change-profile-mobile__body">
            {errorMessage ? (
            ...
            <div className="change-profile-mobile__actions">
              <button
                type="button"
